						...
						<div className="flex flex-col items-center justify-center space-y-4 text-center">
							<div className="space-y-2">
								...
								<p className="text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
									I&apos;ve worked on a variety of projects, from websites to 3D
									printed products.
								</p>
							</div>
						</div>
			...
			<section id="activites">
				<div className="space-y-12 w-full py-12">
                  ...
                  STEM Activites
								...
								<p className="text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
									While at school, I participate in some extracurricular
									activites focusing on STEM. These are the types of projects I
									enjoy doing the most and are the experinces that have allowed
									me to gain the most amount of experince as well as learn new
									skills.
								</p>
							</div>
						</div>
