...
export default function RootLayout({children}:{children:React.ReactNode}){return <html className="scrollbar-none" lang="en" data-scroll-behavior="smooth" suppressHydrationWarning><head><link rel="preload" href="/fonts/hanken-grotesk.woff2" as="font" type="font/woff2" crossOrigin="anonymous"/></head><body className="scrollbar-none"><ThemeProvider attribute="data-theme" defaultTheme="system" enableSystem disableTransitionOnChange><a className="skip" href="#main">{SITE.navigation.skip}</a><SiteHeader/>{children}<SiteFooter/></ThemeProvider></body></html>}
